...
e = Tor10.UniTensor(bonds=[Tor10.Bond(6,Tor10.BD_BRA),Tor10.Bond(6,Tor10.BD_BRA)],N_rowrank=1)
...
# Sparse
a = Tor10.UniTensor(bonds=[Tor10.Bond(3,Tor10.BD_BRA),Tor10.Bond(3,Tor10.BD_KET)],N_rowrank=1,is_diag=True)
print(a)
...
## Testing Getblock:
bd1 = Tor10.Bond(10,Tor10.BD_BRA,qnums=[[ 0]]*3+[[-1]]*5+[[ 2]]*2)
bd2 = Tor10.Bond(6 ,Tor10.BD_KET,qnums=[[ 3]]*2+[[ 0]]*2+[[-1]]*2)
bd3 = Tor10.Bond(5 ,Tor10.BD_KET,qnums=[[ 0]]*2+[[ 1]]*3         )
bd4 = Tor10.Bond(6 ,Tor10.BD_BRA,qnums=[[-1]]*3+[[ 1]]*3         )
